      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex gap-2">
          <Link 
            ...
            className="flex-1 bg-primary-600 text-white py-2 px-4 rounded hover:bg-primary-700 transition duration-300 text-center"
          >
            Voir le projet
          </Link>
          {project.link && (
            <a 
              ...
              className="flex items-center justify-center bg-gray-700 text-white py-2 px-4 rounded hover:bg-gray-600 transition duration-300"
            >
